...
local function GetURL(scripturl)
	if shared.TigerDeveloper then
		assert(betterisfile("Tiger/"..scripturl), "File not found : Tiger/"..scripturl)
		...
		assert(res ~= "404: Not Found", "File not found : Tiger/"..scripturl)
		return res
	end
end
...
do
	...
	function WhitelistFunctions:GetTag(plr)
		...
		if plrstr == "Tiger OWNER" then
			return "[Tiger OWNER] "
		elseif plrstr == "Tiger PRIVATE" then 
			return "[Tiger PRIVATE] "
	...
	function WhitelistFunctions:CheckPlayerType(plr)
		...
		playertype = owner and "Tiger OWNER" or private and "Tiger PRIVATE" or "DEFAULT"
...
shared.Tigerwhitelist = WhitelistFunctions
...
local Radar = GuiLibrary.CreateCustomWindow({
	["Name"] = "Radar", 
	["Icon"] = "Tiger/assets/RadarIcon1.png",
	["IconSize"] = 16
})
...
GuiLibrary["ObjectsThatCanBeSaved"]["GUIWindow"]["Api"].CreateCustomToggle({
	["Name"] = "Radar", 
	["Icon"] = "Tiger/assets/RadarIcon2.png", 
		...
		["Function"] = function(callback)
			if callback then
				...
				if lplr.Character then
					task.spawn(function()
						pcall(function() 
							Cape(lplr.Character, getcustomassetfunc("Tiger/assets/TigerCape.png"))
						end)
					end)
				end
			else
