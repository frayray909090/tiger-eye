if shared.TigerExecuted then
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("Tiger/language.dat") and readfile("Tiger/language.dat") or "en-us",
	...
	local function GetURL(scripturl)
		if shared.TigerDeveloper then
			if not betterisfile("Tiger/"..scripturl) then
				error("File not found : Tiger/"..scripturl)
			end
			return readfile("Tiger/"..scripturl)
		else
			local res = game:HttpGet("https://raw.githubusercontent.com/frayray909090/tiger-eye-prison-life/main/"..scripturl, true)
			assert(res ~= "404: Not Found", "File not found")
			return res
		end
	end

	local translations = shared.TigerTranslation or {}
	...
	coroutine.resume(coroutine.create(function()
		...
		until not shared.TigerExecuted
	end))
	...
	local function getcustomassetfunc(path)
		if not betterisfile(path) then
			...
			local req = requestfunc({
				Url = "https://raw.githubusercontent.com/frayray909090/tiger-eye-prison-life/main/"..path:gsub("Tiger/assets", "assets"),
				Method = "GET"
			})
	...
	searchbaricon.Image = getcustomassetfunc("Tiger/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("Tiger/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("Tiger/assets/WindowBlur.png")
	...
	api["SaveSettings"] = function()
		if loadedsuccessfully then
			writefile(customdir.."Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt", game:GetService("HttpService"):JSONEncode(api["Profiles"]))
			local WindowTable = {}
			...
			writefile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt", game:GetService("HttpService"):JSONEncode(api["Settings"]))
			writefile(customdir.."Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt", game:GetService("HttpService"):JSONEncode(WindowTable))
		end
	end
	...
	api["LoadSettings"] = function(customprofile)
		if identifyexecutor and identifyexecutor():find("ScriptWare") == nil and listfiles then
			for i,v in pairs(listfiles(customdir.."Profiles")) do 
				...
				if (ext and ext:find("Tigerprofile") and ext:find("txt") == nil) then
		...
		if betterisfile("Tiger/Profiles/GUIPositions.Tigerprofile.txt") and game.GameId == 2619619496 then
			writefile("Tiger/Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt", readfile("Tiger/Profiles/GUIPositions.Tigerprofile.txt"))
			if delfile then delfile("Tiger/Profiles/GUIPositions.Tigerprofile.txt") end
		end
		if shared.TigerPrivate then
			if betterisfile("Tigerprivate/Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt") == false and betterisfile("Tiger/Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt") then
				writefile("Tigerprivate/Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt", readfile("Tiger/Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt"))
			end
			if betterisfile("Tigerprivate/Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt") == false and betterisfile("Tiger/Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt") then
				writefile("Tigerprivate/Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt", readfile("Tiger/Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt"))
			end
			if betterisfile("Tigerprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt") == false and betterisfile("Tiger/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt") then
				writefile("Tigerprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt", readfile("Tiger/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofiles.txt"))
		end)
		...
		local success3, result3 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(game.GameId).."GUIPositions.Tigerprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt"))
		end)
	...
	api["SwitchProfile"] = function(profilename)
		...
		if (not betterisfile(customdir.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveTiger or game.PlaceId)..".Tigerprofile.txt")) then
			local realprofile = api["CurrentProfile"]
			api["CurrentProfile"] = profilename
			api["SaveSettings"]()
			api["CurrentProfile"] = realprofile
		end
		local Tigerprivate = shared.TigerPrivate
		local oldindependent = shared.TigerIndependent
		api["SelfDestruct"]()
		if not oldindependent then
			shared.TigerSwitchServers = true
			shared.TigerOpenGui = (clickgui.Visible)
			shared.TigerPrivate = Tigerprivate
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("Tiger/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "Tiger/translations/"..api["Language"].."/TigerLogo1.png" or "Tiger/assets/TigerLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("Tiger/assets/TigerLogo2.png")
		...
		settingsbox2.Text = "Tiger "..VERSION.."  "
		...
		settingswheel.Image = getcustomassetfunc("Tiger/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("Tiger/assets/DiscordIcon.png")
		...
		settingsexit.Image = getcustomassetfunc("Tiger/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("Tiger/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("Tiger/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("Tiger/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("Tiger/assets/BackIcon.png")
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			api["ObjectsThatCanBeSaved"]["TigerSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonapi}
			return buttonapi
		end
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("Tiger/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("Tiger/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("Tiger/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("Tiger/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc("Tiger/assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc("Tiger/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function() 
				bindimg.Image = getcustomassetfunc("Tiger/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("Tiger/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("Tiger/assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.7
				val = val or 0.9
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("Tiger/assets/ColorSlider2.png") or getcustomassetfunc("Tiger/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("Tiger/assets/RainbowIcon2.png") or getcustomassetfunc("Tiger/assets/RainbowIcon1.png"))
			...
			sliderapi["SetRainbow"] = function(val)
				...
				if sliderapi["RainbowValue"] then
					...
					heh = coroutine.resume(coroutine.create(function()
						...
						until sliderapi["RainbowValue"] == false or shared.TigerExecuted == nil
					end))
				end
			end
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("Tiger/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("Tiger/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("Tiger/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("Tiger/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "Tiger/assets/TextBoxBKG2.png" or "Tiger/assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc("Tiger/assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("Tiger/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("Tiger/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("Tiger/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("Tiger/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("Tiger/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("Tiger/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("Tiger/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("Tiger/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "Tiger/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "Tiger/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "Tiger/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "Tiger/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("Tiger/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:Connect(function()
					sliderexpand.Image = getcustomassetfunc("Tiger/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("Tiger/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("Tiger/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("Tiger/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("Tiger/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = getcustomassetfunc("Tiger/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = getcustomassetfunc("Tiger/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("Tiger/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("Tiger/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "Tiger/"..customicon or "Tiger/assets/InfoNotification.png")
