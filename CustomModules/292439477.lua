...
if shared.TigerWaiting then repeat task.wait() until shared.RequireTable end
if shared.RequireTable == nil then 
	if shared.RequireTable == nil then
		...
		prompt:_open("Your exploit is unsupported by Phantom Forces Tiger.")
		task.wait(9e9)
	end
end
local pf = {}
